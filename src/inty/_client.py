...
class Inty(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Inty client instance.

        This automatically infers the `api_key` argument from the `INTY_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("INTY_API_KEY")
        if api_key is None:
            raise IntyError(
                "The api_key client option must be set either by passing api_key to the client or by setting the INTY_API_KEY environment variable"
            )
...
class AsyncInty(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncInty client instance.
