...
from inty.types.api.v1.chats import (
    ChatSettings,
...
class TestAgents:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_settings(self, client: Inty) -> None:
        agent = client.api.v1.chats.agents.get_settings(
            "agent_id",
        )
        assert_matches_type(ChatSettings, agent, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_settings(self, client: Inty) -> None:
        response = client.api.v1.chats.agents.with_raw_response.get_settings(
            "agent_id",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_settings(self, client: Inty) -> None:
        with client.api.v1.chats.agents.with_streaming_response.get_settings(
            "agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_get_settings(self, client: Inty) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.api.v1.chats.agents.with_raw_response.get_settings(
                "",
            )

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_update_chat_settings(self, client: Inty) -> None:
        agent = client.api.v1.chats.agents.update_chat_settings(
            agent_id="agent_id",
        )
        assert_matches_type(AgentUpdateChatSettingsResponse, agent, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_update_chat_settings_with_all_params(self, client: Inty) -> None:
        agent = client.api.v1.chats.agents.update_chat_settings(
            agent_id="agent_id",
            language="language",
            premium_mode=True,
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_update_chat_settings(self, client: Inty) -> None:
        response = client.api.v1.chats.agents.with_raw_response.update_chat_settings(
            agent_id="agent_id",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_update_chat_settings(self, client: Inty) -> None:
        with client.api.v1.chats.agents.with_streaming_response.update_chat_settings(
            agent_id="agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_update_chat_settings(self, client: Inty) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.api.v1.chats.agents.with_raw_response.update_chat_settings(
                agent_id="",
            )
...
class TestAsyncAgents:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_settings(self, async_client: AsyncInty) -> None:
        agent = await async_client.api.v1.chats.agents.get_settings(
            "agent_id",
        )
        assert_matches_type(ChatSettings, agent, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_settings(self, async_client: AsyncInty) -> None:
        response = await async_client.api.v1.chats.agents.with_raw_response.get_settings(
            "agent_id",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_settings(self, async_client: AsyncInty) -> None:
        async with async_client.api.v1.chats.agents.with_streaming_response.get_settings(
            "agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_get_settings(self, async_client: AsyncInty) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.api.v1.chats.agents.with_raw_response.get_settings(
                "",
            )

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_update_chat_settings(self, async_client: AsyncInty) -> None:
        agent = await async_client.api.v1.chats.agents.update_chat_settings(
            agent_id="agent_id",
        )
        assert_matches_type(AgentUpdateChatSettingsResponse, agent, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_update_chat_settings_with_all_params(self, async_client: AsyncInty) -> None:
        agent = await async_client.api.v1.chats.agents.update_chat_settings(
            agent_id="agent_id",
            language="language",
            premium_mode=True,
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_update_chat_settings(self, async_client: AsyncInty) -> None:
        response = await async_client.api.v1.chats.agents.with_raw_response.update_chat_settings(
            agent_id="agent_id",
        )
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_update_chat_settings(self, async_client: AsyncInty) -> None:
        async with async_client.api.v1.chats.agents.with_streaming_response.update_chat_settings(
            agent_id="agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_update_chat_settings(self, async_client: AsyncInty) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.api.v1.chats.agents.with_raw_response.update_chat_settings(
                agent_id="",
            )
