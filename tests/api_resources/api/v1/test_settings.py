...
class TestSettings:
    ...
    def test_streaming_response_retrieve(self, client: Inty) -> None:
        with client.api.v1.settings.with_streaming_response.retrieve() as response:
    ...
    def test_raw_response_update(self, client: Inty) -> None:
        response = client.api.v1.settings.with_raw_response.update()
    ...
    def test_streaming_response_update(self, client: Inty) -> None:
        with client.api.v1.settings.with_streaming_response.update() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSettings:
    ...
    async def test_method_retrieve(self, async_client: AsyncInty) -> None:
        setting = await async_client.api.v1.settings.retrieve()
        assert_matches_type(Settings, setting, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncInty) -> None:
        response = await async_client.api.v1.settings.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncInty) -> None:
        async with async_client.api.v1.settings.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_update(self, async_client: AsyncInty) -> None:
        response = await async_client.api.v1.settings.with_raw_response.update()
    ...
    async def test_streaming_response_update(self, async_client: AsyncInty) -> None:
        async with async_client.api.v1.settings.with_streaming_response.update() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
