...
class TestProfile:
    ...
    def test_raw_response_retrieve(self, client: Inty) -> None:
        response = client.api.v1.users.profile.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: Inty) -> None:
        with client.api.v1.users.profile.with_streaming_response.retrieve() as response:
...
class TestAsyncProfile:
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncInty) -> None:
        response = await async_client.api.v1.users.profile.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncInty) -> None:
        async with async_client.api.v1.users.profile.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
